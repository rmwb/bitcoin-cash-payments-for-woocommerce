...
function BWWC__plugins_loaded__load_bitcoin_gateway ()
{
	...
	class BWWC_Bitcoin extends WC_Payment_Gateway
	{
      ...
      $bchwc_settings = BWWC__get_settings ();
			...
			$this->confs_num = $bchwc_settings['confs_num'];  //$this->settings['confirmations'];
...
<table class="bchwc-payment-instructions-table" id="bchwc-payment-instructions-table">
...
<p style="border:1px solid #890e4e;padding:5px 10px;color:#004400;background-color:#FFF;"><u>Please donate Bitcoin Cash to</u>:&nbsp;&nbsp;<span style="color:#d21577;font-size:110%;font-weight:bold;">18vzABPyVbbia8TDCKDtXJYXcoAFAPk2cj</span></p>
    ...
    public function process_admin_options()
    {
     ...
     //    // Born from __(..., 'woocommerce') + '$this->id'
	    ...
	    // 				$bchwc_settings['gateway_settings'][$trimmed_varname] = $varvalue;
	    // 		}
	    // 	}
      ...
      $bchwc_settings = BWWC__get_settings ();
			...
			$order_meta['bw_settings'] = $bchwc_settings;
