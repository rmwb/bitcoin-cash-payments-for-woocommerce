...
//===========================================================================
function BCHWC__MATH_generate_bitcoin_address_from_mpk_v1 ($master_public_key, $key_index)
{
...
//===========================================================================
function BCHWC__MATH_generate_bitcoin_address_from_mpk_v2 ($master_public_key, $key_index, $is_for_change = false)
{
...
//===========================================================================
function BCHWC__MATH_generate_bitcoin_address_from_mpk ($master_public_key, $key_index, $is_for_change = false)
{
	if (USE_EXT != 'GMP' && USE_EXT != 'BCMATH')
  {
    BCHWC__log_event (__FILE__, __LINE__, "Neither GMP nor BCMATH PHP math libraries are present. Aborting.");
		return false;
  }

  if (preg_match ('/^[a-f0-9]{128}$/', $master_public_key))
    return BCHWC__MATH_generate_bitcoin_address_from_mpk_v1 ($master_public_key, $key_index);

  if (preg_match ('/^xpub[a-zA-Z0-9]{107}$/', $master_public_key))
    return BCHWC__MATH_generate_bitcoin_address_from_mpk_v2 ($master_public_key, $key_index, $is_for_change);

  BCHWC__log_event (__FILE__, __LINE__, "Invalid MPK passed: '$master_public_key'. Aborting.");
  return false;
}
//===========================================================================
